-- ============================================================
-- 000032_update_telegram_notifications.sql
-- Update telegram admin chat_id and translate notifications
-- ============================================================
...
BEGIN
    ...
    IF sender_role = false THEN
        ...
        tg_msg := '💬 <b>Pesan Ruang Kerja Baru</b>' || CHR(10) || CHR(10) ||
                  '<b>Proyek:</b> #' || COALESCE(order_num, 'Tidak diketahui') || CHR(10) ||
                  '<b>Dari:</b> ' || COALESCE(sender_name, 'Klien') || CHR(10) ||
                  '<b>Pesan:</b> ' || NEW.content;
...
BEGIN
    ...
    IF sender_role = false THEN
        ...
        tg_msg := '🎫 <b>Balasan Tiket Bantuan Baru</b>' || CHR(10) || CHR(10) ||
                  '<b>Tiket:</b> ' || COALESCE(ticket_subject, 'Tidak diketahui') || CHR(10) ||
                  '<b>Dari:</b> ' || COALESCE(sender_name, 'Klien') || CHR(10) ||
                  '<b>Pesan:</b> ' || NEW.content;
