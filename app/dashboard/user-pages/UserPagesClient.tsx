  ...
  return (
    <div className="pt-6 px-4 pb-16">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Jelajahi Halaman</h1>
          <p className="text-sm font-medium text-slate-500 mt-1">Sumber daya dan referensi yang bermanfaat tersedia untuk Anda.</p>
        </div>
      ...
      {pages.length === 0 ? (
        <div className="bg-white rounded-2xl ring-1 ring-slate-100 p-12 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900">Tidak ada halaman tersedia</h3>
          <p className="text-sm text-slate-500 mt-1 max-w-md">Belum ada halaman internal yang dipublikasikan untuk pengguna.</p>
        </div>
      ) : (
            ...
            >
               ...
               <div className="flex-1 px-6 sm:px-0 py-4 sm:py-6 relative z-10 flex items-center justify-between gap-6 border-t sm:border-t-0 sm:border-l border-slate-100">
                 <p className="text-sm font-medium text-slate-500 line-clamp-2 max-w-xl">
                   Akses informasi detail mengenai <strong>{p.title}</strong> langsung dari dokumen halaman ini.
                 </p>
